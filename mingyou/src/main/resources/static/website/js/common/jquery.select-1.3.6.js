...
(function ($) {
    $.fn.extend({
        sSelect: function () {
            var isn=this.parents('.dropdown').length;
           /* if(isn>0){
                return false;
            }*/
                ...
                if (obj.style.display != 'none' && $(this).parents()[0].id.indexOf('__jQSelect') < 0) {
                   ...
                   /* if ($.browser.safari) {
                    ...
                    var click_fun = function () {                       
                        ...
                        /*windowspace < ulspace && windowspace2 > 0?$('#'+selectId+' ul').css({top:-ulspace}):*/
                        $('#' + selectId + ' ul').css({top: $('#' + selectId + ' h4').outerHeight(true) - 1});
                    ...
                    $('#' + selectId)
						...
						if($.browser.msie){
						 $('#' + selectId).bind("focusout",function(){
							  $.fn.clearSelectMenu(selectId, selectZindex);                            	 
							 })	;				
							}						
