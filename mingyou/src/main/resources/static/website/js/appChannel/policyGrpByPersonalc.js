		...
		event:function(){
			...
			$("#getVerifyCode").click(function(){
            	...
            	/*if(bln){
            		...
            		noString ="contNo="+datas.contNo;
            	}*/
                $.ajax({
                    type:"POST",
                    async:"fasle",
                    url:"/official-web/api/sms/send",
                    data:"type=G&"+noString+"&mobileNo="+datas.mobileNo+"&idType="+datas.idType+"&idNo="+datas.idNo,
                    dataType:"json",
                ...
                $.ajax({
                    ...
                    success:function(jsonData){
                        ...
                        /*	var url="";*/
                        	...
                        	var	url="policyGrpByPersonalList.html?grpContNo="+datas.grpContNo+"&mobileNo="+datas.mobileNo+"&idType="+datas.idType+"&idNo="+datas.idNo;
                        		/*if(bln)
                        		else
                        		url ="policyPersonalList.html"*/
